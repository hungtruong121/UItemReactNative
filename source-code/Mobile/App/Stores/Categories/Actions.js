...
const { Types, Creators } = createActions({
  fetchProductsByCategory: ['dataPost'],
  fetchProductsByCategoryLoading: null,
  fetchProductsByCategorySuccess: ['productsCategory'],
  fetchProductsByCategoryFailure: ['errorMessage'],
